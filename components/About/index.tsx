...
export default function About() {
  ...
  return (
    ...
    >
      ...
      {/* Radial Orange Glow */}
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-96 h-96 bg-orange/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-orange">TRANSFORM INTO IMPACT</span>
          </h2>

          {/* Vibrant Orange GSAP Word Illuminate */}
          ...
          <blockquote
            className="p-6 rounded-2xl bg-panel border border-orange-dim/30 font-body text-base italic leading-relaxed text-muted"
          >
            ...
            <cite className="not-italic block mt-3 font-mono-data text-xs text-orange font-bold">
              — E-Cell PEC Board
            </cite>
          </blockquote>
        </div>
