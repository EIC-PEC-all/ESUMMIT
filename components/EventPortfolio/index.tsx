    ...
    >
      ...
      <div className="sticky top-0 flex h-screen w-full flex-col justify-between overflow-hidden py-6">
        ...
        <div className="relative z-20 px-8 pt-4">
          <span className="font-mono-data text-xs font-bold uppercase tracking-widest text-mint">PROPOSED ACTIVITIES</span>
          <h2 className="font-display text-3xl sm:text-5xl font-black uppercase text-mint tracking-tight">EVENTS</h2>
        </div>
