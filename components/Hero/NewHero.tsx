      ...
      <div className="sticky top-0 z-0 flex h-screen w-full items-center justify-center overflow-hidden">
        ...
        >
          <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 sm:gap-6 text-center">
            ...
            {/* Main Headline — Compact 2 Lines with Rich Gradients */}
            <h2 
            ...
            >
              <span className="text-gradient-white">WHERE IDEAS RAISE</span> <span className="text-gradient-mint">CAPITAL</span>
              <br />
              <span className="text-gradient-white">&amp; COMPOUND INTO</span> <span className="text-gradient-mint">IMPACT</span>
            </h2>
